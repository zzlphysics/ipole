...
if __name__ == "__main__":
  ...
  for fname in sys.argv[1:]:
    ...
    ax5.set_title("Tb [K]")
    ax6.set_title("convolved Tb [K]")
    ax7.set_title("Tb rotated [K]")
    ax8.set_title("convolved Tb rotated [K]")
    ax9.set_title("Tb with quiver")
    ax10.set_title("convolved Tb with quiver")
    ...
    ax5.set_xlabel(FOV_UNITS)
    ax6.set_xlabel(FOV_UNITS)
    ax7.set_xlabel(FOV_UNITS)
    ax8.set_xlabel(FOV_UNITS)
    ax9.set_xlabel(FOV_UNITS)
    ax10.set_xlabel(FOV_UNITS)
